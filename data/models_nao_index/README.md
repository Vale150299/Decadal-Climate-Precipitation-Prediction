...
- `notebooks/01_load_and_prepare_model_data_NAO.ipynb`  [Load_prepare NAO_Data](../notebooks/01_load_and_prepare_model_data_NAO.ipynb)
- `notebooks/02_compute_NAO_model_index.ipynb`          [Compute NAO Index](../notebooks/02_compute_NAO_model_index.ipynb)
